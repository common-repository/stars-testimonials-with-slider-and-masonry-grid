...
class Star_testimonials_form_review_box
{
	 ...
	 * @access public
	 */
	public $pluginName = "Stars Testimonials";
	 ...
	 * @access public
	 */
	public $pluginSlug = "stars-testimonials";
	 ...
	 * @access public
	 */
	public $wpPluginSlug = "stars-testimonials-with-slider-and-masonry-grid";
...
//	    $this->reviewStatus = true;
	...
	public function enqueue_scripts() {
		if (current_user_can('manage_options')) {
			wp_enqueue_style($this->pluginSlug."-star-rating-svg", plugins_url('css/admin/star-rating-svg.css', __FILE__), [], PREMIO_TESTIMONIAL_PLUGIN_VERSION);
			wp_enqueue_script($this->pluginSlug."-star-rating-svg", plugins_url('js/admin/jquery.star-rating-svg.min.js', __FILE__), ['jquery'], PREMIO_TESTIMONIAL_PLUGIN_VERSION);
		}
	}
	...
	public function admin_notices()
	{
        ...
        <script>
            (function($) {
                ...
                StarsTestimonialsFreeReview.prototype.getSelectors = function() {
                    return {
                        body: 'body',
                ...
                StarsTestimonialsFreeReview.prototype.getElements = function() {
                ...
                StarsTestimonialsFreeReview.prototype.bindEvents = function() {
                ...
                StarsTestimonialsFreeReview.prototype.feedbackFormHandler = function(ev) {
                    ev.preventDefault();
                    const elements  = this.getElements();
                ...
                StarsTestimonialsFreeReview.prototype.thankYouDismissHandler = function() {
                    const elements = this.getElements();
                    elements.$reviewBox.remove();
                    elements.$reminderPopup.remove();
                    this.sendHideRequest( -1 );
                ...
                StarsTestimonialsFreeReview.prototype.reminderHandler = function(ev) {
                    ev.preventDefault();
                ...
                StarsTestimonialsFreeReview.prototype.toggleReminderPopup = function( action = true ) {
                    if( action ) {
                ...
                StarsTestimonialsFreeReview.prototype.feedbackToggle = function( action = true ) {
                    const elements = this.getElements();
                    console.log(action);
                    if( action ) {
                ...
                StarsTestimonialsFreeReview.prototype.renderRating = function() {
                    const self      = this;
                ...
                new StarsTestimonialsFreeReview();
