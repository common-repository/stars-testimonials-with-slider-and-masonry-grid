...
//		add_filter('views_edit-stars_testimonial', array($this, 'stars_testimonials_edit_list'));
    ...
    function enqueue_scripts() {
        ...
        wp_enqueue_script( 'wcp-read-more', plugin_dir_url( __FILE__ ).'js/read-more.js', array('jquery'));
    }
	...
	function plugin_redirect() {
		if (!defined("DOING_AJAX") && get_option('stars_testimonail_plugin_redirection', false)) {
