...
<div class="wrap">
    ...
    <div class="testimonial-page">
        <div class="testimonial-title"><?php esc_html_e('Update testimonial', 'stars-testimonials'); ?></div>
            ...
            <form action="<?php echo admin_url() ?>" id="add_testimonial_item" method="post" >
                <div class="tst-form-field">
                    <div class="tst-form-field-left">
                        <label for="post_title"><?php esc_html_e('Client name:', 'stars-testimonials'); ?></label>
                    </div>
                ...
                <div class="tst-form-field">
                    ...
                    <div class="tst-form-field-right">
                        <div class="testimonial-text-area">
                            ...
                            ?>
                            <div class="tst-placeholder" style="display: <?php echo empty($post->post_content)?"block":"none" ?>"><?php esc_html_e('Type in the testimonial here', 'stars-testimonials'); ?></div>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <div style="display: none">
                        <textarea name="testimonial_content" id="testimonial_content" ><?php echo esc_attr($post->post_content) ?></textarea>
                    </div>
                </div>
                <div class="tst-form-field">
                    <div class="tst-form-field-left">
                ...
                <div class="tst-form-field">
                    <div class="tst-form-field-left">
                        <label for="website_link"><?php esc_html_e('Client image', 'stars-testimonials'); ?></label>
                    </div>
                    <div class="tst-form-field-right">
                        ...
                        <div class="image-buttons">
                            ...
                            <button type="button" class="button button-secondary remove-image <?php echo (!empty($image_url))?"active":"" ?>"><?php esc_html_e('Remove image', 'stars-testimonials'); ?></button>
