...
class Stars_testimonials_upgrade_box {
    ...
    public function __construct() {
        add_action("wp_ajax_".$this->plugin_slug."_upgrade_hide_box", array($this, "stars_testtimonials_upgradetopro"));
...
$Stars_testimonials_upgrade_box = new Stars_testimonials_upgrade_box();